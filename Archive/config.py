...
def certificateFunc():
    while True:
        user_input = str(input("[!] Do you wish to create a Self Signed Cert?\n" + "[+] Type 'yes' or 'no'\n"))
        #print(user_input)
...
def removePrintStatements():
    while True:
        ...
        user_input = str(input("[!] Do you wish to strip print statements from final Agent File?" + '\n' + "[+] Type 'yes' or 'no'" + '\n'))
...
def stripCommentsFunc():
    while True:
        ...
        s = open(temp, 'r').read()
        user_input = str(input("[!] Do you wish to strip comments from final Agent File?" + '\n' + "[+] Type 'yes' or 'no'" + '\n'))
